...
> **⚠️ Mobile Platform Note:** The Swift iOS rewrite has been abandoned — iOS severely restricts background BLE scanning. See [PLATFORM_LIMITATIONS.md](PLATFORM_LIMITATIONS.md) for the full technical assessment.
